		...
		<div class="goods_content fl mt10 ml10">
			...
			<div class="summary">
                ...
                <div class="preview fl">
                    <div class="midpic">
                        <a href="<?=$model->LOGO?>" class="jqzoom" rel="gal1"style="width: 500px">   <!-- 第一幅图片的大图 class 和 rel属性不能更改 -->
                            <img src="<?=$model->LOGO?>" alt="" style="width: 300px"/>               <!-- 第一幅图片的中图 -->
                        </a>
                    </div>
                        ...
                        <div class="smallpic_wrap">
                            <ul>
                                <?php foreach ($gallerys as $k=>$gallery):?>
                                    <li <?=$k?'':'class="cur"'?>>
                                        <a <?=$k?'':'class="zoomThumbActive"'?> href="javascript:void(0);" rel="{gallery: 'gal1', smallimage: '<?='http://admin.yii2shop.com'.$gallery->path?>',largeimage: '<?='http://admin.yii2shop.com'.$gallery->path?>'}">
                                            <img src="<?='http://admin.yii2shop.com'.$gallery->path?>"></a>
                                    </li>
                                <?php endforeach;?>
				...
				<div class="goodsinfo fl ml10">
					...
					<form action="http://www.yii2shop.com/cart/addcart.html" method="get" class="choose">
						<ul>
