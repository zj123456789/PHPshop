				...
				<ul>
					<li>
                        ...
                        <?php else:?>
                            ...
                            [<a href="logout.html">注销</a>] [<a href="address.html">收货地址</a>]
                        <?php endif;?>
                    </li>
					<li class="line">|</li>
					<li>我的订单</li>
		...
		<div class="nav w1210 bc mt10">
			...
			<div class="category fl"> <!-- 非首页，需要添加cat1类 -->
				...
				<div class="cat_bd">
                    ...
                    <div class="cat <?=$k?'':'itme1'?>">
                        <h3><a href="<?=\yii\helpers\Url::to(['goods-category/list','category_id'=>$category->id])?>"><?=$category->name?></a> <b></b></h3>
                        <div class="cat_detail">
                            <?php foreach ($category->children(1)->all() as $i=>$child):?>
                            <dl <?=$i?'':'class="dl_1st"'?>>
                                <dt><a href="<?=\yii\helpers\Url::to(['goods-category/list','category_id'=>$child->id])?>"><?=$child->name?></a></dt>
                                <dd>
                                    <?php foreach ($child->children()->all() as $list):?>
                                    <a href="<?=\yii\helpers\Url::to(['goods-category/list','category_id'=>$list->id])?>"><?=$list->name?></a>
                                    <?php endforeach;?>
                                </dd>
                            </dl>
                            <?php endforeach;?>
